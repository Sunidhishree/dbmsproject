...
export default function UserLogin() {
    ...
    const handleGoogleSignIn = async () => {
        ...
        try {
            ...
            if (!registerResponse.ok) throw new Error('Failed to save user profile')
            ...
            <div className="content-shell relative z-10 min-h-screen flex items-center justify-center px-4 py-12">
                <div className="w-full max-w-md">
                    <div className="surface-card p-8">
                        <h1 className="text-center font-heading text-5xl text-dark mb-3">Welcome Back</h1>
                        <p className="text-gray text-center mb-8">Login to your account</p>
