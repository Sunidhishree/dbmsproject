...
export default function AdminSignup() {
    ...
    const handleGoogleSignUp = async () => {
        ...
        try {
            ...
            if (!registerResponse.ok) throw new Error('Failed to save admin profile')
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Register admin in MongoDB via Flask
            ...
            <div className="content-shell relative z-10 min-h-screen flex items-center justify-center px-4 py-12">
                <div className="w-full max-w-md">
                    <div className="surface-card p-8">
                        ...
                        <p className="text-gray text-center mb-8">Register as Administrator</p>
